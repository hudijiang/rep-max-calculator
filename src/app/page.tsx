...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-gray-200 font-sans selection:bg-blue-600 selection:text-white overflow-hidden">
      ...
      {/* --- First Screen: Immersive Calculator --- */}
      <section className="relative z-10 min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        <div className="w-full max-w-4xl mx-auto flex flex-col items-center space-y-8 lg:space-y-12">
          ...
          <div className="text-center space-y-6 animate-fade-in-up">
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed font-light hidden sm:block">
              Optimize your training intensity for <strong>Bench, Squat, and Deadlift</strong>.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-24">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="p-4 bg-purple-900/10 border border-purple-900/30 rounded-xl inline-block">
            ...
            <div>
              {/* Visual Graphic Placeholder or Additional Context */}
              <div className="bg-gradient-to-br from-gray-900 to-black p-8 rounded-3xl border border-gray-800 relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-32 h-32 bg-blue-600/20 rounded-full blur-[50px] group-hover:bg-blue-600/30 transition-colors"></div>
                <h3 className="text-2xl font-bold text-white mb-4">Why it matters</h3>
                <ul className="space-y-4 text-gray-400">
                  <li className="flex items-start gap-3">
                    <span className="text-green-500 font-bold">✓</span>
                    <span>Track strength gains securely without maxing out every week.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-green-500 font-bold">✓</span>
                    <span>Calculate precise loads for hypertrophy (70-80%) vs strength (85%+).</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-green-500 font-bold">✓</span>
                    <span>Prevent injury by avoiding ego-lifting failure.</span>
                  </li>
                </ul>
              </div>
            </div>
